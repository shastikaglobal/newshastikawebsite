...
import ShipBackdrop from "../components/ShipBackdrop";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">This page has sailed beyond our routes.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium agricultural exports from India. Coconuts, fresh fruits, vegetables and spices delivered to 30+ countries with uncompromising quality." },
      { name: "author", content: "Shastika Global Impex Pvt. Ltd." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Sora:wght@300;500;700;800&family=Inter:wght@300;400;500;600&display=swap" },
    ],
  }),
